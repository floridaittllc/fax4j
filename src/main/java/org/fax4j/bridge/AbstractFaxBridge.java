 ...
 * Specific implementations may provide additional, more transport based capabilities. <br>
...
public abstract class AbstractFaxBridge implements FaxBridge {
    ...
    public final synchronized void initialize(String type, Properties configuration, Object flowOwner) {
        ...
        this.bridgeLogger
                .logDebug(
                        new Object[] { "Initializing fax bridge of type: ", this.getClass().getName(),
                                "\nProvider Information:\n", this.getProvider(), "\nFax Bridge Configuration:\n",
                                configuration, "\nVendor Policy Type: ", this.vendorPolicy.getClass().getName() },
                        null);
